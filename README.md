...
- **Port forwarding fails with NAT-PMP timeouts:** Use `arr.vpn.troubleshoot` for diagnostics, then configure P2P servers with `arr.vpn.p2p config`. See [Port forwarding P2P guide](docs/port-forwarding-p2p.md) for details.
...
- [Port forwarding P2P guide](docs/port-forwarding-p2p.md)
